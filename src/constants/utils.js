const REGEXP_IF_18 = "(13518(([01][0-9][0-9])|([2][01][0-9])|([2][2][01])))";
const REGEXP_STI_18 = "(18218(([01][0-9][0-9])|([2][01][0-9])|([2][2][01])))";
...
export const REGEXP_NIM = `^(${REGEXP_IF_18}|${REGEXP_STI_18}|${REGEXP_IF_19}|${REGEXP_STI_19}|${REGEXP_IF_20}|${REGEXP_STI_20})$`;
